#!/usr/bin/env python3
"""
Mine-Coin Official PC Miner 1.0 © MIT licensed
https://
https://github.com/adarshsreedhar/mine-coin
Mine-Coin Team & Community 2021-2022
"""
...
class Settings:
    ...
    SEPARATOR = ","
    VER = 1.0
    DATA_DIR = "Mine-Coin PC Miner " + str(VER)
